...
{
    /// <summary>
    /// Retrieves the app domain to use for the given test.
    /// </summary>
    /// <param name="testMethodInfo"> Information about the method under test for which the appdomain is being constructed.</param>
    ...
    /// <summary>
    /// Marks the app-domain as no longer used for the given context.
    /// </summary>
